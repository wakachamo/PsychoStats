 ...
 *	works with PHP5 w/o any deprecated errors (also see class_XML5.php for details).
 *
 */

if (defined("CLASS_XMLDATA4_PHP")) return 1; 
define("CLASS_XMLDATA4_PHP", 1); 
...
class XMLstruct {
	...
	function XMLstruct(){
		...
		xml_set_element_handler($this->parser, array(&$this, 'open'), array(&$this, 'close'));
